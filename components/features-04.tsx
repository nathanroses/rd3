              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Seamless Integration</h4>
                  </div>
                  <p className="text-sm text-slate-400">Effortlessly connect with essential services leveraging our custom solutions for enhanced functionality and user experience.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Tailored Connectivity</h4>
                  </div>
                  <p className="text-sm text-slate-400">Our API strategies are designed to seamlessly blend with your business model, ensuring each integration feels native to your platform.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                  ...
                  <p className="text-sm text-slate-400"> Scale your operations with our dynamic API systems that support your expanding business needs without interruption.</p>
                </div>
              </div>
            </div>
            {/* Row */}
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Intuitive Design</h4>
                  </div>
                  <p className="text-sm text-slate-400">Craft engaging digital experiences with our user-centric interfaces that drive customer satisfaction and retention.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Personalized Access</h4>
                  </div>
                  <p className="text-sm text-slate-400">Empower your clients with dedicated portals that offer real-time insights into their projects, fostering transparency and trust.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                  ...
                  <p className="text-sm text-slate-400">Elevate your brand with our suite of engagement tools designed to increase user interaction and actionable feedback.</p>
                </div>
              </div>
            </div>
            {/* Row */}
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Advanced Protection</h4>
                  </div>
                  <p className="text-sm text-slate-400">Deploy state-of-the-art security measures that defend against digital threats while maintaining user accessibility.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Regulatory Adherence</h4>
                  </div>
                  <p className="text-sm text-slate-400">Stay ahead of privacy concerns with our compliance-oriented development, ensuring you respect global data protection standards.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Encrypted Interactions</h4>
                  </div>
                  <p className="text-sm text-slate-400">Secure your customer transactions with our robust encryption protocols, providing peace of mind with every digital exchange.</p>
                </div>
              </div>
            </div>
          </div>
