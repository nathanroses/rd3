      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">Look for yourself at our customer reviews. We want you to be added to this wall so we can continue to give great service.</p>
          </div>
          {/* Customers */}
