  ...
  const items: Item[] = [
    {
      ...
      twitter: '#0',
      quote: "Our collaboration with Rose Development has been transformative. Their exceptional business acumen and innovative strategies have significantly enhanced our operational efficiency.",
    },
    {
      img: Testimonial01,
      name: 'Samantha Green',
      role: 'Director, Green Solutions',
      twitter: '#0',
      quote: "Rose Development stands out for their meticulous attention to detail and commitment to excellence. Working with them has yielded remarkable results in our project management processes.",
    },
    {
      img: Testimonial03,
      name: 'Lucas Martinez',
