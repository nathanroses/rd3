            ...
            <div className="md:flex justify-between space-x-6 md:space-x-8 lg:space-x-14">
              ...
              <div className="max-w-[548px] mx-auto">
                <div className="text-slate-400 space-y-6">
                  ...
                  <p>
                  At its core, Rose Development was conceived as a <strong className="text-slate-50 font-medium"> solution to a common problem faced by business owners seeking success in the digital age without the need to immerse themselves in the complexities of technology</strong>, The aim was to blend the latest technological advancements with a personalized approach, ensuring that each client's unique needs were met with precision and creativity.
                  </p>
                  <p>
