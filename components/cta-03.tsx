      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-slate-400 mb-8">Enter your email below for personalized quotes and expert insights tailored to your needs. Rose Development is your Partner in Web Services</p>
