        ...
        <div className="pt-16 md:pt-32">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          ...
                          <p className="text-slate-400">Unlock limitless potential with modular add-ons that grow with your business, ensuring a future-proof online presence.</p>
                        </div>
                      </div>
                      {/* Image */}
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">Advanced filtering to swiftly navigate and manage user data, enhancing site functionality and user experience.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
              ...
              <p className="text-sm text-slate-400">Fully customizable website features that adapt to your brand's unique needs, offering a personalized digital platform.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
              ...
              <p className="text-sm text-slate-400">Future-proof your website with regular updates that keep you ahead of technological advancements and market trends.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
              ...
              <p className="text-sm text-slate-400">Robust authorization protocols ensure secure user access and data protection, building trust and compliance.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
              ...
              <p className="text-sm text-slate-400">Streamlined content and user management systems enable efficient administration of your digital presence.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
              ...
              <p className="text-sm text-slate-400">Construct your online presence with state-of-the-art building tools designed for optimal performance and scalability.</p>
            </div>
          </div>
